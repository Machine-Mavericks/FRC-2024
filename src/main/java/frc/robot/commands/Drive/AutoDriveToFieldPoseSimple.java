...
public class AutoDriveToFieldPoseSimple extends Command { 
  ...
  public AutoDriveToFieldPoseSimple(Pose2d target, double speed, double rotationalspeed, double timeout) {
...
/** Creates a new AutoDriveToPoseCommand. 
   * Use this to have command to drive back to coordinate provided to it */
  public AutoDriveToFieldPoseSimple(Pose2d target, double Xspeed, double Yspeed, double rotationalspeed, double timeout) {
    addRequirements(RobotContainer.drivetrain);
    m_target = target;
