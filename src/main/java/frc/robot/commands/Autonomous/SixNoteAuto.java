...
public class SixNoteAuto extends SequentialCommandGroup {
  ...
  public SixNoteAuto() {
    ...
    new AutoDriveToPose(AutoFunctions.redVsBlue(new Pose2d(  2.1,4, new Rotation2d())), 0.5*Drivetrain.MAX_VELOCITY_METERS_PER_SECOND, 0.5*Drivetrain.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND, 3),    
