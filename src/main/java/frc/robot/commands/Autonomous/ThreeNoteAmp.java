...
public class ThreeNoteAmp extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAmp. */
  public ThreeNoteAmp() {
    ...
    new AimThenShootSpeaker(), 
    new CleanupShot(),
    new AutoDriveToFieldPose(AutoFunctions.redVsBlue(new Pose2d(7.3,7.5, new Rotation2d(Math.toRadians(180.0)))), 0.5, 0.5, 3),
    new SteerToNote(true, 2.0, 0.2),
    new AutoDriveToFieldPose(AutoFunctions.redVsBlue(new Pose2d(5.2,6.9, new Rotation2d(Math.toRadians(180.0)))), 0.5, 0.5, 3),
    new AimThenShootSpeaker(), 
    new CleanupShot()
