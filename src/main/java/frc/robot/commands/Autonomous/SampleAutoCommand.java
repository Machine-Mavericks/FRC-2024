...
public class SampleAutoCommand extends SequentialCommandGroup {
  ...
  public SampleAutoCommand() {
    addCommands(
      new AutoDriveToPose(AutoFunctions.redVsBlue(AutoFunctions.NotesAtStart[3]), Drivetrain.MAX_VELOCITY_METERS_PER_SECOND, Drivetrain.MAX_ANGULAR_VELOCITY_RADIANS_PER_SECOND, 5)
    );
