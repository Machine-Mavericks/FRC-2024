...
public class FourNoteSource extends SequentialCommandGroup {
  ...
  public FourNoteSource() {
    ...
    // move away from post
    new AutoDriveToFieldPose(AutoFunctions.redVsBlue(new Pose2d(  1.5,3.5, new Rotation2d(Math.toRadians(180.0)))), 0.5, 0.5, 3),
    ...
    new AutoDriveToFieldPose(AutoFunctions.redVsBlue(new Pose2d(5.2,1.7, new Rotation2d(Math.toRadians(180.0)))), 0.5, 0.5, 10)  
    ...
    // new AutoDriveToPose(AutoFunctions.redVsBlue(new Pose2d(2,4, new Rotation2d())),  0.5, 0.5, 3),
